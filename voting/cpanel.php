    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg"><strong> NIGERIA ELECTION SYSTEM </strong></a>
        </div>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong> BOLA TINUBU </strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>PETER OBI</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                // TMC
                $sql ="SELECT * FROM tbl_users WHERE voted_for='NNPP'";
                $result= mysqli_query($conn, $sql);
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>ALHAJI YAHAYA</strong><br>";
                  echo "
                  <div class='progress'>
